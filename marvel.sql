...
UPDATE people SET name = 'Great Brute' WHERE name = 'Graeme Broose';
SELECT name FROM people;
SELECT name FROM people WHERE name = 'Stuart Bryce';
DELETE FROM movies WHERE title = 'Batman Begins';
INSERT INTO people(name) VALUES ('John the teacher');
DELETE FROM people WHERE name = 'Harvey Wheaton';
INSERT INTO movies (title, year, show_time) VALUES ('Spider-man: Homecoming', 2017, ':0021:19');
UPDATE movies SET show_time = '20:00' WHERE title = 'Guardians of the Galaxy 2';
DELETE FROM movies WHERE title = 'Ant-Man' OR title = 'Doctor Strange' OR year = 2014; 
SELECT * FROM movies; 
